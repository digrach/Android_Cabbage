...
public class CheckinPlayerTask extends AsyncTask<Void,Void,String> {
	...
	public CheckinPlayerTask(int playerid, String superid, Activity initiatingActivity) {
	...
	protected String doInBackground(Void... arg0) {
		//Log.d("START CheckinPlayerTask", "START CheckinPlayerTask");

		StringBuilder str = new StringBuilder();
		String url = "http://playcabbage.chisholm.edu.au/rest/checkins/checkinPlayer";
		...
		try {
			...
			while((line = reader.readLine()) != null) {
				str.append(line);
				//Log.d("Reading here t2", "here");
			}
			is.close();
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		//Log.d("CheckinPlayerTask", str.toString());
	...
	protected void onPostExecute(String s) {
		...
		CollectibleBean cb = jf.fromCollectibleBeanJson(s);

		// Now return to the onAsyncTaskCompleted method in the initiating IAsyncHelper activity....
		//		ItemSummaryActivity activityInstanceName = (ItemSummaryActivity)initiatingActivity;
		//		activityInstanceName.onAsyncTaskComplete(cb, "checkinplayer");

		CheckinActivity activityInstanceName = (CheckinActivity)initiatingActivity;
		activityInstanceName.onAsyncTaskComplete(cb, "checkinplayer");
