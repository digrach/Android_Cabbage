...
public class GetLeaderBoardTask extends AsyncTask<Void,Void,String> {
	private String jaffaappkey;

	private Activity initiatingActivity;

	public GetLeaderBoardTask(Activity initiatingActivity) {
	...
	protected String doInBackground(Void... arg0) {
		//Log.d("START GetLeaderBoardTask", "START GetLeaderBoardTask");

		StringBuilder str = new StringBuilder();
		String url = "http://playcabbage.chisholm.edu.au/rest/leaderboard/getleaderboard";
		...
		//Log.d("GetLeaderBoardTask", str.toString());
	...
	protected void onPostExecute(String s) {
		...
		//Log.d("doodle",s);
		List<LeaderBoardBean> lbList = jf.fromLeaderBoardBeanListJson(s);
		...
		ps.onAsyncTaskComplete(lbList, "leaderboard");
