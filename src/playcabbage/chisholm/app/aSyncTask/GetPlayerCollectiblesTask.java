...
public class GetPlayerCollectiblesTask extends AsyncTask<Void,Void,String> {
	private String jaffaappkey;

	private String playerid;
	private Activity initiatingActivity;

	public GetPlayerCollectiblesTask(int playerid, Activity initiatingActivity) {
	...
	protected String doInBackground(Void... arg0) {
		//Log.d("START GetPlayerCollectiblesTask", "START GetPlayerCollectiblesTask");

		StringBuilder str = new StringBuilder();
		String url = "http://playcabbage.chisholm.edu.au/rest/players/getCollectedByPlayer";
		HttpClient client = new DefaultHttpClient();
		/// POST ///
		HttpPost post = new HttpPost(url);
		List<NameValuePair> nvList = new ArrayList<NameValuePair>();
		BasicNameValuePair bnvp1 = new BasicNameValuePair("playerid", playerid);
		...
		//Log.d("GetPlayerCollectiblesTask", str.toString());
	...
	protected void onPostExecute(String s) {
		...
		// Now return to the onAsyncTaskCompleted method in the initiating IAsyncHelper activity....
		     ItemListActivity activityInstanceName = (ItemListActivity)initiatingActivity;
		     activityInstanceName.onAsyncTaskComplete(cbList, "playercollectibles");
